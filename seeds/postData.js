...
[
  ...
  },
  {
    ...
    description: "There is a difference between authentication and authorization. Authentication means confirming your own identity, where as authorization means being allowed access to the sytem."
  },
  {
...
const postSeeded = () => Post.bulkCreate(postContent);

module.exports = postSeeded;